  ...
  - Docker Hub Login — Authenticates using mdharun and the          
  ...
  │      Workflow       │             Image              │             
  ├─────────────────────┼────────────────────────────────┤             
  │ llm-multiroute      │ mdharun/llm-multiroute      │             
  ├─────────────────────┼────────────────────────────────┤             
  │ llm-frontend-python │ mdharun/llm-frontend-python │             
  └─────────────────────┴────────────────────────────────┘             
  Required secret
  Add this in your repo settings (Settings > Secrets and variables > Actions):
  Secret: DOCKERHUB_TOKEN
  Purpose: Docker Hub access token for mdharun (generate at https://hub.docker.com/settings/security)
